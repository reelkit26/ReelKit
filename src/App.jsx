...
export default function App() {
  ...
  const applyBlur=(ctx,canvas,box)=>{
    ...
    const{x,y,w,h}=box;
    const blurAmt=Math.max(16,Math.min(w,h)*0.4), pad=24;
  ...
  if(screen==="home") return(
    <div style={{minHeight:"100vh",background:c.bg,fontFamily:"-apple-system,BlinkMacSystemFont,'Inter',sans-serif",color:c.txt,display:"flex",flexDirection:"column"}}>
      ...
      {/* Hero */}
      <div style={{background:"linear-gradient(150deg,#1a1a2a,#2d1b69)",padding:"44px 20px 52px",boxSizing:"border-box"}}>
        <div style={{maxWidth:680,margin:"0 auto",textAlign:"center"}}>
          <h1 style={{fontSize:"clamp(28px,5vw,42px)",fontWeight:900,color:"#fff",margin:"0 0 10px",lineHeight:1.1}}>
          ...
          <p style={{color:"rgba(255,255,255,0.55)",fontSize:15,margin:"0 0 30px"}}>Remove watermarks from videos & images. Generate AI SEO. 100% free.</p>
      ...
      {/* Below hero */}
      <div style={{maxWidth:680,margin:"0 auto",padding:"24px 20px 0",boxSizing:"border-box",width:"100%"}}>
        {/* SEO results */}
      ...
      {/* How it works + Footer */}
      <div style={{maxWidth:680,margin:"0 auto",padding:"0 20px 0",boxSizing:"border-box",width:"100%",flex:1}}>
        {!isPaid&&(
  ...
  if(screen==="select") return(
    <div style={{height:"100dvh",background:"#f4f4f8",display:"flex",flexDirection:"column",fontFamily:"-apple-system,BlinkMacSystemFont,'Inter',sans-serif",overflow:"hidden"}}>
      ...
      <div style={{flex:1,display:"flex",flexDirection:"column",padding:"12px 16px 14px",gap:10,overflow:"hidden",minHeight:0,boxSizing:"border-box"}}>
        ...
        <p style={{margin:0,fontSize:13,color:"#888"}}>✍️ Draw a box over the watermark — we'll blur it out</p>
  ...
  if(screen==="result") return(
    <div style={{height:"100dvh",background:"#f4f4f8",display:"flex",flexDirection:"column",fontFamily:"-apple-system,BlinkMacSystemFont,'Inter',sans-serif",overflow:"hidden"}}>
      ...
      <div style={{flex:1,display:"flex",flexDirection:"column",padding:"12px 16px 14px",gap:10,overflow:"hidden",minHeight:0,boxSizing:"border-box"}}>
        ...
        {/* Download */}
        <button onClick={()=>{const a=document.createElement("a");a.href=processedUrl;a.download=isPaid?"reelkit_hd.jpg":"reelkit_compressed.jpg";a.click();}}
          style={{width:"100%",padding:"15px",borderRadius:12,border:"none",cursor:"pointer",fontSize:16,fontWeight:700,color:"#fff",background:G,boxSizing:"border-box",flexShrink:0}}>
          {isPaid?"↓ Download Full HD":"↓ Download (Compressed)"}
        </button>
  ...
  if(screen==="imgselect") return(
    <div style={{height:"100dvh",background:"#f4f4f8",display:"flex",flexDirection:"column",fontFamily:"-apple-system,BlinkMacSystemFont,'Inter',sans-serif",overflow:"hidden"}}>
      ...
      <div style={{flex:1,display:"flex",flexDirection:"column",padding:"12px 16px 14px",gap:10,overflow:"hidden",minHeight:0,boxSizing:"border-box"}}>
        ...
        <p style={{margin:0,fontSize:13,color:"#888"}}>✍️ Draw a box over the watermark to blur it</p>
    ...
    <div style={{position:"fixed",inset:0,background:"rgba(0,0,0,0.75)",display:"flex",alignItems:"flex-end",zIndex:400}}>
      <div style={{width:"100%",maxWidth:600,margin:"0 auto",background:"#fff",borderRadius:"22px 22px 0 0",padding:"26px 20px 52px",boxSizing:"border-box"}}>
        <div style={{display:"flex",justifyContent:"space-between",alignItems:"center",marginBottom:6}}>
          <div style={{fontWeight:800,fontSize:22}}>Welcome to ReelKit</div>
        ...
        <p style={{color:"#888",fontSize:14,marginBottom:22,marginTop:4}}>Sign in free — no password needed</p>
        ...
        <button onClick={hGoogle} disabled={!!loading}
          style={{width:"100%",padding:"14px",borderRadius:12,border:"1.5px solid #e2e2e8",cursor:loading?"not-allowed":"pointer",fontSize:15,fontWeight:600,color:"#111",background:"#fff",display:"flex",alignItems:"center",justifyContent:"center",gap:12,marginBottom:10,opacity:loading?0.7:1,boxSizing:"border-box"}}>
        ...
        <button onClick={hFacebook} disabled={!!loading}
          style={{width:"100%",padding:"14px",borderRadius:12,border:"none",cursor:loading?"not-allowed":"pointer",fontSize:15,fontWeight:600,color:"#fff",background:"#1877F2",display:"flex",alignItems:"center",justifyContent:"center",gap:12,opacity:loading?0.7:1,boxSizing:"border-box",marginBottom:18}}>
